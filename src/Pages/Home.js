  ...
  const getMessages = async () => {
    try {
      const res = await axios.get(
        "https://msnger-bcknd.herokuapp.com/api/messages/" + currentChat._id
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://msnger-bcknd.herokuapp.com/api/messages/",
        config
      );
    ...
    if (file) {
      ...
      try {
        const res = await axios.post(
          "https://msnger-bcknd.herokuapp.com/api/upload/",
          data
        );
        setFile(null);
      } catch (err) {
  ...
  const helperCreateChat = async (c) => {
    ...
    if (!c._id) {
      try {
        ...
        const res = await axios.post(
          "https://msnger-bcknd.herokuapp.com/api/conversations",
          config
        );
